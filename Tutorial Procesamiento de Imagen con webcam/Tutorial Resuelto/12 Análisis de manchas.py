...
def rgb():
    ...
    Minimos = (int(SRedI.get()), int(SGreenI.get()), int(SBlueD.get()))
...
def manchas():
    ...
    CajaTexto.insert(tk.END, cadena)
...
Umbra=tk.Button(ventana, text="Umbralización", command=rgb)
Umbra.place(x=840,y=430,width=80,height=23)
Manchas=tk.Button(ventana, text="Análisis de manchas", command=manchas)
Manchas.place(x=1120,y=330,width=100,height=23)
...
CajaTexto.place(x=1055, y=50, width=255, height=220)
ventana.mainloop()
