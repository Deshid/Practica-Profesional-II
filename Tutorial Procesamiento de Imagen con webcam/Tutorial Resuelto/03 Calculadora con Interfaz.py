...
botonMultiplicacion = Button(ventana, text="Multiplicación", width=8, height=1, command= lambda:clickBotonMultiplicacion(entradaUno.get(), entradaDos.get()))
botonDivision = Button(ventana, text="División", width=8, height=1, command= lambda:clickBotonDivision(entradaUno.get(), entradaDos.get()))
